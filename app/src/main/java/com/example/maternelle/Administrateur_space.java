...
public class Administrateur_space extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrateur_space);
        ...
        Btnpublier=(Button) findViewById(R.id.btnPublierExercice);
